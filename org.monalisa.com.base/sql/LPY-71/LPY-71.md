...
- AD_Column_Compiere_Create_UPSERTS.sql
  Crea lax Querys los UPSERTS de AD_Column de las tablas compiere
- AD_Column_MOLI_Create_UPSERTS.sql
  Crea las Querys de los UPSERTS de AD_Column de las tablas MOLI

- AD_Column_Compiere_UPSERTS.sql
  Query para Actualizar AD_Column de las tablas compiere
- AD_Column_MOLI_UPSERTS.sql
  Query para Actualizar AD_Column de las tablas MOLI
