...
// N
	...
	*/
	...
	/** Set Auth No.
		@param MOLI_AuthNo Auth No
	*/
	public void setMOLI_AuthNo (String MOLI_AuthNo)
	{
		set_Value (COLUMNNAME_MOLI_AuthNo, MOLI_AuthNo);
	}

	/** Get Auth No.
		@return Auth No	  */
	public String getMOLI_AuthNo()
	{
		return (String)get_Value(COLUMNNAME_MOLI_AuthNo);
	}
	...
	*/
	...
	/** Devolución y Ajuste de precios = 1 */
	public static final String MOLI_CREDITNOTEREASON_DevoluciónYAjusteDePrecios = "1";
	/** Devolución = 2 */
	public static final String MOLI_CREDITNOTEREASON_Devolución = "2";
	/** Descuento = 3 */
	public static final String MOLI_CREDITNOTEREASON_Descuento = "3";
	/** Bonificación = 4 */
	public static final String MOLI_CREDITNOTEREASON_Bonificación = "4";
	/** Crédito incobrable = 5 */
	public static final String MOLI_CREDITNOTEREASON_CréditoIncobrable = "5";
	/** Recupero de costo = 6 */
	public static final String MOLI_CREDITNOTEREASON_RecuperoDeCosto = "6";
	/** Recupero de gasto = 7 */
	public static final String MOLI_CREDITNOTEREASON_RecuperoDeGasto = "7";
	/** Ajuste de precio = 8 */
	public static final String MOLI_CREDITNOTEREASON_AjusteDePrecio = "8";
	/** Set Credit Note Reason.
		@param MOLI_CreditNoteReason Credit Note Reason
	*/
	public void setMOLI_CreditNoteReason (String MOLI_CreditNoteReason)
	{

		set_Value (COLUMNNAME_MOLI_CreditNoteReason, MOLI_CreditNoteReason);
	}

	/** Get Credit Note Reason.
		@return Credit Note Reason	  */
	public String getMOLI_CreditNoteReason()
	{
		return (String)get_Value(COLUMNNAME_MOLI_CreditNoteReason);
	}

	/** Set Currency Rate.
		@param MOLI_CurrencyRate Currency Rate
	*/
	public void setMOLI_CurrencyRate (BigDecimal MOLI_CurrencyRate)
	{
		set_Value (COLUMNNAME_MOLI_CurrencyRate, MOLI_CurrencyRate);
	}

	/** Get Currency Rate.
		@return Currency Rate	  */
	public BigDecimal getMOLI_CurrencyRate()
	{
		BigDecimal bd = (BigDecimal)get_Value(COLUMNNAME_MOLI_CurrencyRate);
		if (bd == null)
			 return Env.ZERO;
		return bd;
	}
	...
	*/
	...
	/** Set Fs Void Message.
		@param MOLI_FsVoidMessage Fs Void Message
	*/
	public void setMOLI_FsVoidMessage (String MOLI_FsVoidMessage)
	{
		set_Value (COLUMNNAME_MOLI_FsVoidMessage, MOLI_FsVoidMessage);
	}

	/** Get Fs Void Message.
		@return Fs Void Message	  */
	public String getMOLI_FsVoidMessage()
	{
		return (String)get_Value(COLUMNNAME_MOLI_FsVoidMessage);
	}

	/** Generado = 00 */
	public static final String MOLI_FSVOIDSTATUS_Generado = "00";
	/** Enviado en un Lote = 01 */
	public static final String MOLI_FSVOIDSTATUS_EnviadoEnUnLote = "01";
	/** Aprobado = 02 */
	public static final String MOLI_FSVOIDSTATUS_Aprobado = "02";
	/** Aprobado con observación = 03 */
	public static final String MOLI_FSVOIDSTATUS_AprobadoConObservación = "03";
	/** Rechazado = 04 */
	public static final String MOLI_FSVOIDSTATUS_Rechazado = "04";
	/** Borrador = -1 */
	public static final String MOLI_FSVOIDSTATUS_Borrador = "-1";
	/** Inutilizado = 97 */
	public static final String MOLI_FSVOIDSTATUS_Inutilizado = "97";
	/** Inexistente = 98 */
	public static final String MOLI_FSVOIDSTATUS_Inexistente = "98";
	/** Cancelado = 99 */
	public static final String MOLI_FSVOIDSTATUS_Cancelado = "99";
	/** Set Fs Void Status.
		@param MOLI_FsVoidStatus Fs Void Status
	*/
	public void setMOLI_FsVoidStatus (String MOLI_FsVoidStatus)
	{

		set_Value (COLUMNNAME_MOLI_FsVoidStatus, MOLI_FsVoidStatus);
	}

	/** Get Fs Void Status.
		@return Fs Void Status	  */
	public String getMOLI_FsVoidStatus()
	{
		return (String)get_Value(COLUMNNAME_MOLI_FsVoidStatus);
	}

	/** Set Numero de Timbrado.
		@param MOLI_InvAuth Numero de Timbrado
	*/
	public void setMOLI_InvAuth (String MOLI_InvAuth)
	{
		set_Value (COLUMNNAME_MOLI_InvAuth, MOLI_InvAuth);
	}

	/** Get Numero de Timbrado.
		@return Numero de Timbrado	  */
	public String getMOLI_InvAuth()
	{
		return (String)get_Value(COLUMNNAME_MOLI_InvAuth);
	}

	/** Set Invoice NO.
		@param MOLI_InvoiceNo Invoice NO
	*/
	public void setMOLI_InvoiceNo (String MOLI_InvoiceNo)
	{
		set_Value (COLUMNNAME_MOLI_InvoiceNo, MOLI_InvoiceNo);
	}

	/** Get Invoice NO.
		@return Invoice NO	  */
	public String getMOLI_InvoiceNo()
	{
		return (String)get_Value(COLUMNNAME_MOLI_InvoiceNo);
	}

	/** Set Timbrado Asociado.
		@param MOLI_LinkAuthId Timbrado Asociado
	*/
	public void setMOLI_LinkAuthId (String MOLI_LinkAuthId)
	{
		set_Value (COLUMNNAME_MOLI_LinkAuthId, MOLI_LinkAuthId);
	}

	/** Get Timbrado Asociado.
		@return Timbrado Asociado	  */
	public String getMOLI_LinkAuthId()
	{
		return (String)get_Value(COLUMNNAME_MOLI_LinkAuthId);
	}

	/** Set Factura Asociado.
		@param MOLI_LinkInvNo Factura Asociado
	*/
	public void setMOLI_LinkInvNo (String MOLI_LinkInvNo)
	{
		set_Value (COLUMNNAME_MOLI_LinkInvNo, MOLI_LinkInvNo);
	}

	/** Get Factura Asociado.
		@return Factura Asociado	  */
	public String getMOLI_LinkInvNo()
	{
		return (String)get_Value(COLUMNNAME_MOLI_LinkInvNo);
	}

	/** Set Pre Imp NO.
		@param MOLI_PreImpNO Pre Imp NO
	*/
	public void setMOLI_PreImpNO (String MOLI_PreImpNO)
	{
		set_Value (COLUMNNAME_MOLI_PreImpNO, MOLI_PreImpNO);
	}
	...
	{
		return (String)get_Value(COLUMNNAME_MOLI_PreImpNO);
	}
