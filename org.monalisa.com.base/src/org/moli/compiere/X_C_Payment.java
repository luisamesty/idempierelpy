...
// S
	...
	*/
	...
	/** Set PostDated Check.
		@param MOLI_PostDatedCheck PostDated Check
	*/
	public void setMOLI_PostDatedCheck (Timestamp MOLI_PostDatedCheck)
	{
		set_Value (COLUMNNAME_MOLI_PostDatedCheck, MOLI_PostDatedCheck);
	}

	/** Get PostDated Check.
		@return PostDated Check	  */
	public Timestamp getMOLI_PostDatedCheck()
	{
		return (Timestamp)get_Value(COLUMNNAME_MOLI_PostDatedCheck);
	}
