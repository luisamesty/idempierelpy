...
public interface I_I_Product 
{
    ...
    /** Column name AttributeSet_Value */
    public static final String COLUMNNAME_AttributeSet_Value = "AttributeSet_Value";

	/** Set AttributeSet Key.
	  * AttributeSet Descriptor in JSON
	  */
    ...
    /** Column name ProductLine_Value */
    public static final String COLUMNNAME_ProductLine_Value = "ProductLine_Value";

	/** Set ProductLine  Key.
	  * ProductLine Value for search
	  */
    ...
    /** Column name TaxCategory_Value */
    public static final String COLUMNNAME_TaxCategory_Value = "TaxCategory_Value";
